...
// Part Supply Warehouse exercise  
...
let supplyChanges : number[] = [3, 5, -6, 0, 7, 11];
...
for (let i : number = 0; i < supplyChanges.length; i += 1) {
